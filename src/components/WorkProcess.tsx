...
const steps = [
    ...
    },
    {
        ...
        desc: "Te entregamos un <b>documento detallado</b> con todo lo que incluye el servicio seleccionado. Luego de revisarlo y aceptarlo, coordinamos reunión por <b>Google Meet</b> o vía WhatsApp para alinear detalles.",
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
